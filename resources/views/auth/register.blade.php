            ...
            <div class="card auth-card">
                <div class="card-body p-4 p-sm-5">
                    ...
                    <div class="app-brand justify-content-center mb-4 flex-column text-center">
                        ...
                        <p class="text-muted small mb-0">Lengkapi data diri untuk membuat akun pendaftaran calon kru magang SKM Amanat</p>
                    </div>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                        ...
                        <!-- Nama Lengkap -->
                        <div class="mb-3">
                            <label for="name" class="form-label fw-semibold text-heading">Nama Lengkap <span class="text-danger">*</span></label>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-sm-6">
                                <label for="nim" class="form-label fw-semibold text-heading">NIM <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                            ...
                            <div class="col-sm-6">
                                <label for="prodi" class="form-label fw-semibold text-heading">Program Studi <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                        ...
                        <!-- Email -->
                        <div class="mb-3">
                            <label for="email" class="form-label fw-semibold text-heading">Alamat Email Aktif <span class="text-danger">*</span></label>
                            <div class="input-group input-group-merge">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-sm-6 form-password-toggle">
                                <label class="form-label fw-semibold text-heading" for="password">Kata Sandi <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    ...
                                    <input 
                                        ...
                                        required 
                                    />
                                    <span class="input-group-text cursor-pointer" onclick="togglePass('password', 'iconPass1')"><i id="iconPass1" class="bx bx-hide"></i></span>
                                </div>
                            </div>
                            <div class="col-sm-6 form-password-toggle">
                                <label class="form-label fw-semibold text-heading" for="password_confirmation">Ulangi Sandi <span class="text-danger">*</span></label>
                                <div class="input-group input-group-merge">
                                    ...
                                    <input 
                                        ...
                                        required 
                                    />
                                    <span class="input-group-text cursor-pointer" onclick="togglePass('password_confirmation', 'iconPass2')"><i id="iconPass2" class="bx bx-hide"></i></span>
                                </div>
                            </div>
                        </div>
