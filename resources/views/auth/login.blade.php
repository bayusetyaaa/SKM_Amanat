        ...
        <div class="authentication-inner py-4">
            ...
            <div class="card auth-card">
                <div class="card-body p-4 p-sm-5">
                        ...
                        <div class="mb-3 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input 
                                    ...
                                    required 
                                />
                                <span class="input-group-text cursor-pointer" onclick="togglePasswordVisibility()"><i id="togglePassIcon" class="bx bx-hide"></i></span>
                            </div>
                        </div>
                    ...
                    <!-- Quick Demo Accounts Divider -->
                    <div class="divider my-4">
                        <div class="divider-text text-uppercase text-muted fw-bold" style="font-size: 0.72rem; letter-spacing: 0.5px;">Akses Demo Cepat</div>
                    </div>

                    <!-- 2 Demo Buttons (Admin & Cakruma) -->
                    <div class="row g-2 mb-4">
                        <div class="col-6">
                            <button type="button" class="btn w-100 p-2 demo-account-btn text-start d-flex align-items-center gap-2 rounded-3" onclick="fillCredentials('admin@amanat.id', 'password')">
                                <span class="badge bg-label-primary p-2 rounded-circle shrink-0"><i class="bx bx-shield-quarter fs-5"></i></span>
                                <div class="overflow-hidden">
                                    <div class="fw-bold text-heading small text-truncate">Admin/HRD</div>
                                    <small class="text-muted text-truncate d-block" style="font-size: 10.5px;">admin@amanat.id</small>
                                </div>
                            </button>
                        </div>
                        <div class="col-6">
                            <button type="button" class="btn w-100 p-2 demo-account-btn text-start d-flex align-items-center gap-2 rounded-3" onclick="fillCredentials('andi@gmail.com', 'password')">
                                <span class="badge bg-label-info p-2 rounded-circle shrink-0"><i class="bx bx-user fs-5"></i></span>
                                <div class="overflow-hidden">
                                    <div class="fw-bold text-heading small text-truncate">Cakruma</div>
                                    <small class="text-muted text-truncate d-block" style="font-size: 10.5px;">andi@gmail.com</small>
                                </div>
                            </button>
                        </div>
                    </div>
